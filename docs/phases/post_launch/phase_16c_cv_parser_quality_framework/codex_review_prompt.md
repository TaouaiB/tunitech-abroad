# Codex Review Prompt — Phase 16C — CV Parser Quality Framework
...
Then inspect Gemini's changes for Phase 16C only.

## Mission

Verify and repair Phase 16C: Make CV parsing measurable and prevent confident garbage such as name="je me suis".
