# Gemini Prompt — Phase 16G — Admin Monitoring and Alerts
...
```text
docs/phases/post_launch/phase_16g_*/tasks.md
docs/phases/post_launch/phase_16g_*/acceptance.md
docs/phases/post_launch/phase_16g_*/phase_manifest.md
docs/phases/post_launch/phase_16g_*/manual_test_checklist.md
docs/phases/post_launch/phase_16g_*/browser_checklist.md
```

## Mission

Build solo-admin operational dashboards, protected CV access, audit logs, and alert emails.

## Phase scope

```text
- operations dashboard
- data/search/CV/parser/skill dashboards
- protected admin CV download
- AdminFileAccessLog
- AdminAlertService
- admin digest/alerts to env-configured email
```
