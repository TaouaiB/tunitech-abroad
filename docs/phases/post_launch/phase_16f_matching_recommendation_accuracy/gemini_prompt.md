# Gemini Prompt — Phase 16F — Matching and Recommendation Accuracy
...
```text
docs/phases/post_launch/phase_16f_*/tasks.md
docs/phases/post_launch/phase_16f_*/acceptance.md
docs/phases/post_launch/phase_16f_*/phase_manifest.md
docs/phases/post_launch/phase_16f_*/manual_test_checklist.md
docs/phases/post_launch/phase_16f_*/browser_checklist.md
```

## Mission

Improve deterministic match score, score breakdown, recommendation reasons, and missing-skill actions.
