# Codex Review Prompt — Phase 16A — Production Stabilization
...
Then inspect Gemini's changes for Phase 16A only.

## Mission

Verify and repair Phase 16A: Fix production trust issues before product expansion.
