# Codex Review Prompt — Phase 16I — Email Professionalization
...
Then inspect Gemini's changes for Phase 16I only.

## Mission

Verify and repair Phase 16I: Make transactional/admin emails professional, safe, French-ready, and plain-text compatible.
