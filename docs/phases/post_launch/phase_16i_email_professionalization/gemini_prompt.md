# Gemini Prompt — Phase 16I — Email Professionalization
...
```text
docs/phases/post_launch/phase_16i_*/tasks.md
docs/phases/post_launch/phase_16i_*/acceptance.md
docs/phases/post_launch/phase_16i_*/phase_manifest.md
docs/phases/post_launch/phase_16i_*/manual_test_checklist.md
docs/phases/post_launch/phase_16i_*/browser_checklist.md
```

## Mission

Make transactional/admin emails professional, safe, French-ready, and plain-text compatible.
...
- admin alert emails
- optional CV parsed notification
