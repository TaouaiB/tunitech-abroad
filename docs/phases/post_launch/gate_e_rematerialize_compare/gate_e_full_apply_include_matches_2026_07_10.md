...
- timestamp: 2026-07-10T17:52:22.614283+00:00
- git_commit: a13655d
- settings_module: config.settings.local
- database: engine=django.db.backends.postgresql, host=localhost, name=tunitech_abroad, port=5432
- backup_path: /tmp/tuniatlas_gate_e_backup_20260710_175122.dump
- mode: apply
- processed_jobs: 171
- failures: 0
...
- recommendations_refreshed: 43
- matches_refreshed: 45
- cvs_reparsed: 0
...
- recommendation/match score consistency uses actual current scores: pass (comparable_pairs=38, mismatches=0)
