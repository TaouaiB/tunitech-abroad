...
class SkillSeedService:
    ...
    def seed_initial_taxonomy(cls) -> dict:
        ...
        seed_data: List[SkillSeedItem] = [
            ...
            {"canonical": "Ruby", "category": SkillCategory.PROGRAMMING_LANGUAGE.value, "aliases": ["Ruby", "Ruby on Rails", "RoR"]},
            ...
            {"canonical": "ASP.NET", "category": SkillCategory.BACKEND.value, "aliases": ["ASP.NET", "ASP.NET Core"]},
        ...
        with transaction.atomic():
            for item in seed_data:
                ...
                for alias_text in aliases:
                    ...
                    if normalized:
                        alias_obj, alias_created = SkillAlias.objects.get_or_create(
